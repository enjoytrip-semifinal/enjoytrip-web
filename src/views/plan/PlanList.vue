  ...
  <div class="plan-container">
    ...
    <div class="list-container">
      ...
      <div
        ...
        :key="plan['itineraryId']"
      >
        <PlanListItemVue :plan="plan" />
      </div>
      <div class="board-pagination">
        <PageNation @pageFromChild="pageChange" :type="'plan'" />
      </div>
    </div>
  </div>
</template>
...
import { listPlan } from '../../utils/plan';
import PlanListItemVue from './PlanListItem.vue';

export default {
  name: 'TripPlanList',
  components: { PageNation, PlanListItemVue },
  data() {
    return {
      selectList: [
        { name: '전체검색', value: 'all' },
    ...
    loadPlan() {
      listPlan(
        ...
        ({ data }) => {
          ...
          this.planList = data.itineraryList;
        },
        (error) => {
          console.log(error);
        }
