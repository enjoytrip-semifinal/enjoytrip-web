...
export default {
  name: 'TripPlanWrite',
  components: { PlanCard, DatePicker },
  computed: {
  ...
  watch: {
    time3() {
      let start =
        this.time3[0].getFullYear().toString() +
        (this.time3[0].getMonth().toString().length === 1
          ? `0${this.time3[0].getMonth().toString()}`
          : this.time3[0].getMonth().toString()) +
        (this.time3[0].getDate().toString().length === 1
          ? `0${this.time3[0].getDate().toString()}`
          : this.time3[0].getDate().toString());
      let end =
        this.time3[1].getFullYear().toString() +
        (this.time3[1].getMonth().toString().length === 1
          ? `0${this.time3[1].getMonth().toString()}`
          : this.time3[1].getMonth().toString()) +
        (this.time3[1].getDate().toString().length === 1
          ? `0${this.time3[1].getDate().toString()}`
          : this.time3[1].getDate().toString());
      console.log(this.time3[0].getFullYear());
